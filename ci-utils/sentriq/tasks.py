...
def create_pr(fix_id: str, user_id=None) -> dict:
    ...
    try:
        ...
        # TODO(concerns.md#1): push still uses the shared PAT because executor.apply_fix_and_push
        # reads config.GIT_TOKEN internally and cannot accept a per-user token without editing executor.py.
