    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-4">
      ...
      <main className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-surface-container border-2 border-outline p-8 mb-8 relative shadow-[8px_8px_0px_0px_#151922]">
          {/* Decorative Corners */}
          <div className="absolute top-0 left-0 w-2 h-2 border-t-2 border-l-2 border-primary -mt-[2px] -ml-[2px]" />
          <div className="absolute top-0 right-0 w-2 h-2 border-t-2 border-r-2 border-primary -mt-[2px] -mr-[2px]" />
          <div className="absolute bottom-0 left-0 w-2 h-2 border-b-2 border-l-2 border-primary -mb-[2px] -ml-[2px]" />
          <div className="absolute bottom-0 right-0 w-2 h-2 border-b-2 border-r-2 border-primary -mb-[2px] -mr-[2px]" />
          ...
          <div className="flex flex-col items-center text-center space-y-6">
            ...
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 border-2 border-primary bg-surface-container-high flex items-center justify-center mb-4">
                <span className="material-symbols-outlined text-primary text-4xl material-symbols-filled">security</span>
              </div>
              <h1 className="font-display-lg text-display-lg text-on-surface uppercase mb-1">SENTRIQ</h1>
              <span className="font-code-label text-code-label text-primary bg-primary-fixed/10 px-2 py-1 border border-primary/30">
                SEC_OPS_TERMINAL v2.4
              </span>
            </div>
